...
Table 4-5. -- Monitored catch^1^ (metric tons), total catch, and percent monitored (%) of groundfish and halibut retained and discarded in the groundfish and halibut fisheries in `r as.numeric(format(Sys.Date(), "%Y"))-1` in the *Bering Sea/Aleutian Islands*.  Empty cells indicate that no catch occurred.
...
flextable(tem_summary) %>% 
  ...
  add_header_row(values = c("", "Trip", "Weight", "Trip", "Weight", "Trip", "Weight"),
