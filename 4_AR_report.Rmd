...
Max.ts.date <- merge(Max.ts.date, select(partial_time, c(STRATA, Rate, Effective_Date, Expire_After))) %>%
               filter(MAX_TARGET_DATE >= Effective_Date & MAX_TARGET_DATE <= Expire_After)
