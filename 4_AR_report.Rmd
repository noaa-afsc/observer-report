...
flextable(trip.budget.table.2022) %>%
  ...
  colformat_num(j = 3, i = c(2, 4:7), digits = 0) %>%
...
#grid.arrange(grobs = list(outcomes.plot.2022, costs.plot.2022), ncol = 1, widths = c(0.9, 1))

# Make a list of grobs of your figures, set the widths as the maximum among the figures.
#plot_grobs <- lapply(list(fig1, fig2), ggplotGrob)
