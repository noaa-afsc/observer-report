...
```{r outcomes.plot}
# Isolate ADP sampling effort predictions for the chosen design
sample_pops_out <- adp_out$BUD[ALLO == "min_plus_opt"]

# Plot effort predictions against actual
outcomes.plot <-
  ggplot(sample_pops_out, aes(x = ADP_D)) +
...
days_paid <- filter(days_paid, Calendar == 2020)
...
# Plot
costs.plot <- ggplot(sample_pops_out, aes(x = ADP_C)) +
