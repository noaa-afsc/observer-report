...
kbl(Coverage.Table, escape = FALSE) %>% 
  ...
  # Group rows
  pack_rows("Jan. 1 - Mar. 25", 7, 9, label_row_css = "text-align: center") %>% 
  pack_rows("Mar. 26 - Jun. 30", 10, 12, label_row_css = "text-align: center") %>% 
  pack_rows("Jul. 1 - Dec. 31", 13, 15, label_row_css = "text-align: center") 
```
