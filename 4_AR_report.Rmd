...
#'TODO *MOVE THIS TO 1_AR_data.rdata*
#' TODO Move if/else to `1_AR_data.R` and include `FMA_Day_Paid` object when the `2_AR_data.Rdata` object is saved.
...
if( !(file.exists("source_data/FMA_Days_Paid.rdata")) ) {
  #' Download the following spreadsheet as a `.csv` format file tothe `source_data/` folder. Upload  an `.rdata` copy to 
