...
#plot_grobs <- lapply(list(outcomes.plot.2022, costs.plot.2022), ggplotGrob)

#plot_grobs_widths <- do.call(unit.pmax, plot_grobs, function(x) x[["widths"]])

#for(i in 1:length(plot_grobs)) plot_grobs[[i]]$widths <- plot_grobs_widths




grid.arrange(outcomes.plot.2022, costs.plot.2022, nrow = 2)
grid.arrange(outcomes.plot.2023, costs.plot.2023, nrow = 2)
