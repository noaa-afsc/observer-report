...
# FIXME the code above was hardcoded for 2019 strata. Hardcoding 2020 strata below.
strata.cell.dat <- transform(strata.cell.dat, STRATA=factor(STRATA,levels=c("EM HAL", "EM POT", "EM TRW EFP", "HAL", "POT", "TRW")))
...
results <- cbind(results, strat_interp = c(
  ...
  "These results mean that there was some clustering of observed trips among NMFS Areas that was different from expected.  Some spatial bias appears to have occurred in the *EM TRW EFP* stratum.",
    "These results mean that there was no clustering of observed trips among NMFS Areas that was different from expected.  No spatial bias appears to have occurred in the *HAL - No Tender* stratum.",
