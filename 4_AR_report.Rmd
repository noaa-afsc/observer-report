...
# 1 zero coverage EM research (Zero EM Research) +   ## Not this in 2022?
...
kbl(Coverage.Table, escape = FALSE) %>% 
  ...
  pack_rows("Partial coverage observed: Jan. 1 - Dec. 31", 7, 10, label_row_css = "text-align: center") %>% 
  pack_rows("Zero coverage: Jan. 1 - Dec. 31", 11, 11 label_row_css = "text-align: center")
```
