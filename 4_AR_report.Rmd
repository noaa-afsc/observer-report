...
trip.budget.table <- 
  full_join(trip.budget.table, filter(partial, !(STRATA %like% "EM")) %>% distinct(STRATA, formatted_strat), by="STRATA") %>%
  select(Strata = formatted_strat, pred_days, act_days, diff, perc)
```
