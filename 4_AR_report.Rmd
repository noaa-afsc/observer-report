...
#' \TODO The check below had two vessels that failed the check, and in both instances they were OB FIXED BSAI straum 
#' trips that had three-in-a-row releases. We had a known bug that the release table was not populating when ODDS 
#' correctly applied the non-selected status to these trips. For Now I'm hardcoding this fix
if(year == 2024) {
  setDT(odds.dat)
