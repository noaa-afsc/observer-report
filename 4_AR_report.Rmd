...
Given the design, the level of dockside observation of walleye pollock deliveries should be 100% in the full coverage category. In 2019, 100% of full coverage walleye pollock deliveries were observed (`r tbl_nums('Pollock.observed.table', display = "cite")`, `r tbl_nums('Pollock.efp.table', display = "cite")`).   
