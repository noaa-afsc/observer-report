...
YEAR <- c(2022, 2023)
Date <- as.Date(c("2022-01-01", "2023-01-01",  # Lower limit
                  "2022-12-31", "2023-12-31")) # Upper limit
ff <- data.frame(Date, YEAR)
...
Temporal.plot <- 
  ...
  geom_point(data = ff, y = NA) + # Dummy variable to set x axis limits
  theme_bw() +
  theme(axis.text.x = element_text(angle = 90)) +
