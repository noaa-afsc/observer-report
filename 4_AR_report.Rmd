...
Pollock.landing.data <- work.data %>%
  ...
  # Check for non-pollock EM trawl offloads
  {
    ...
    if (non_pollock_count$`nrow(filtered_data)` > 0) {
      print(paste(non_pollock_count$`nrow(filtered_data)`, "EM trawl offload(s) non-pollock"))
    } else {
  ...
  rbind(
    work.offload.trw_em %>%
      ...
      #'*2024 AR* incorrect assignment of PORT_CODE for 1 tender delivery - VMS says it was at AKU
