...
- Trips by trawl vessels listed under the Pollock Trawl EM EFP monitored 100% at-sea by EM systems, monitored shoreside by observers, and fishing in the Gulf of Alaska (`r strata.rates$label[7]` shoreside). Note that vessels fishing under this EFP in the Bering Sea are managed within the full coverage category.\
