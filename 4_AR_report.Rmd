...
eval.2022 <- 
  ...
  mutate(
    ...
    pct.budget.spent = round(ActualYR.2022/PredictedYR.2022, digits = 3) * 100,
...
BUDGET.2022 <- bud_scen_lst$bud_TYFCPN$BUD$BUD #dp_res$BUD$BUD
...
# Get the budget used in the ADP
BUDGET.2023 <- bud_scen_lst$bud_TYFCPN$BUD$BUD #dp_res$BUD$BUD
