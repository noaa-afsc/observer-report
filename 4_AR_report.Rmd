...
partial_og <- partial     # 2020-ONLY: Saving original partial object from work.data for strata will different selection rates at different time periods
partial <- partial[1:6]   # 2020-ONLY: Keep only 1 row per stratum, otherwise later code will break. 
