...
The sample sizes available and the results of permutation tests are presented in `r tbl_nums('perm.summary.table', display = "cite")`. A visual depiction of individual results of this permutation test is given in `r fig_nums('Obs.perm.plot', display = "cite")` for illustration purposes. Observed trips in the *OB FIXED GOA* stratum were 10.4% (0.6 days) shorter in duration and were on vessels 4.9% (2.8 ft) longer than unmonitored trips. Monitored trips in the EM FIXED BSAI stratum were on vessels 16.2% (14.0 ft) shorter than unmonitored trips. Monitored trips in the EM FIXED GOA stratum landed 24.3% (0.9 species) more species than unmonitored trips. While not directly comparable, the previouslu used hook-and-line observer and EM strata showed similar patterns in 2023, with shorter trips in the observer stratum and more species landed in the EM stratum during monitored trips (AFSC and AKRO 2024).
