...
- [*TODO - Data timeliness methods were updated?*]
- Updates to Trawl EM calculations?
...
The sample sizes available and the results of permutation tests are presented in `r tbl_nums('perm.summary.table', display = "cite")`. A visual depiction of individual results of this permutation test is given in `r fig_nums('Obs.perm.plot', display = "cite")` for illustration purposes. Observed trips in the *OB FIXED GOA* stratum were 10.4% (0.6 days) shorter in duration and were on vessels 4.9% (2.8 feet) longer than unmonitored trips. Monitored trips in the EM FIXED BSAI stratum were on vessels 16.2% (14.0 feet) shorter than unmonitored trips. Monitored trips in the EM FIXED GOA stratum landed catch that was 24.3% (0.9 species) more diverse than unmonitored trips.
...
`r fig_nums('review_times_figure', caption = "Distributions of review timeliness (the time between a trip or delivery ending and those trips being reviewed and known to catch accounting) by stratum. Solid black lines and annotations to the left show median review timeliness. Dashed red lines and annotations to the right show mean review timeliness.")`  
