...
flextable(trip.budget.table.2022) %>%
  ...
  colformat_num(j = 3, i = c(1:3, 5, 7), digits = 0) %>%
...
disposition.table <- disposition.table %>%
  ...
  arrange(factor(Strata, levels = c("EM HAL", "EM POT", "OB HAL", "OB POT", "OB TRW", "Total")))
...
flextable(disposition.table.2022) %>%
  ...
  hline(i = c(4, 10, nrow(disposition.table.2022)), border = officer::fp_border(width = 2)) %>%
  surround(part = "header", border.top = officer::fp_border(width = 2), border.bottom = officer::fp_border(width = 2)) %>%
  fix_border_issues() %>%
...
flextable(disposition.table.2023) %>%
  ...
  hline(i = c(4, 10, nrow(disposition.table.2023)), border = officer::fp_border(width = 2)) %>%
  surround(part = "header", border.top = officer::fp_border(width = 2), border.bottom = officer::fp_border(width = 2)) %>%
  fix_border_issues() %>%
  width(j = 1, 0.7, unit = "in") %>%
  width(j = c(2, 9), 0.94, unit = "in") %>%
...
flextable(logged.table.2022) %>%
  ...
  bold(bold = TRUE, part = "header") %>%
  merge_v(j = 1) %>%
  hline(i = c(2, 5, nrow(logged.table.2022)), border = officer::fp_border(width = 2)) %>%
  surround(part = "header", border.top = officer::fp_border(width = 2), border.bottom = officer::fp_border(width = 2)) %>%
  fix_border_issues() %>%
...
flextable(logged.table.2023) %>%
  ...
  bold(bold = TRUE, part = "header") %>%
  merge_v(j = 1) %>%
  hline(i = c(2, 5, nrow(logged.table.2023)), border = officer::fp_border(width = 2)) %>%
  surround(part = "header", border.top = officer::fp_border(width = 2), border.bottom = officer::fp_border(width = 2)) %>%
  fix_border_issues() %>%
  width(j = 1, 0.69, unit = "in") %>%
  width(j = 2, 0.5, unit = "in") %>%
...
Selection.table <- Selection.table %>%
  mutate(Year = as.factor(Year)) %>%
  arrange(factor(Strata, levels = c("EM HAL", "EM POT", "OB HAL", "OB POT", "OB TRW")))
...
flextable(Selection.table.2022) %>%
  ...
  hline(i = c(8, nrow(Selection.table.2022)), border = officer::fp_border(width = 2)) %>%
  surround(part = "header", border.top = officer::fp_border(width = 2), border.bottom = officer::fp_border(width = 2)) %>%
  fix_border_issues() %>%
...
flextable(Selection.table.2023) %>%
  ...
  hline(i = c(8, nrow(Selection.table.2023)), border = officer::fp_border(width = 2)) %>%
  surround(part = "header", border.top = officer::fp_border(width = 2), border.bottom = officer::fp_border(width = 2)) %>%
  fix_border_issues() %>%
  width(j = c(1, 3), 0.69, unit = "in") %>%
  width(j = 2, 2.21, unit = "in") %>%
