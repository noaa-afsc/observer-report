...
```{r load_data}
load("spatiotemp_analysis.rdata")
```
...
print(plt.iterspersion.stratum.2023)
```
...
print(plt.iterspersion.stratum_fmp.2023)
```
...
print(plt.iterspersion.stratum.2022)
```
...
print(plt.iterspersion.stratum_fmp.2022)
```
