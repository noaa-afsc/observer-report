...
where extract(year from t.trip_start_date_time) = 2023
...
ob_trips <- dbGetQuery(channel_afsc, 
  "select extract(year from t.start_date) as year, t.cruise, t.permit, t.trip_seq, t.end_date as trip_end
   ...
   where extract(year from t.start_date) = 2023
...
where extract(year from delivery_end_date) = 2023")
...
if(!file.exists("figures/data_timeliness.png")){
  ggsave(filename = "figures/data_timeliness.png", width = 6, height = 5, units = 'in')}
```
